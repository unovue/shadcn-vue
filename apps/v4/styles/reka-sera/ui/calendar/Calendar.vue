...
import { NativeSelect, NativeSelectOption } from '@/styles/reka-sera/ui/native-select'
...
<template>
  ...
  <CalendarRoot
    ...
    data-slot="calendar"
    :class="cn('p-3 [--cell-radius:0] [--cell-size:--spacing(8)] group/calendar bg-background in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent', props.class)"
  >
