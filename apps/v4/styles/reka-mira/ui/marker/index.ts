...
export const markerVariants = cva(
  'gap-2 text-xs/relaxed text-muted-foreground [a]:hover:text-foreground [a]:underline-offset-3 [a]:underline [&_svg:not([class*=\'size-\'])]:size-3.5 min-h-4 text-left group/marker relative flex w-full items-center',
  {
    variants: {
      variant: {
        default: '',
