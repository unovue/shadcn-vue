...
import NavMain from '@/registry/new-york-v4/blocks/Sidebar07/components/NavMain.vue'
import NavProjects from '@/registry/new-york-v4/blocks/Sidebar07/components/NavProjects.vue'
