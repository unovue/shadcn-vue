...
import { iconLibraries } from '@/registry/config'
  ...
  <div class="group/picker relative">
    <Picker>
      <PickerTrigger>
        ...
        <div
          class="text-foreground *:[svg]:text-foreground! pointer-events-none absolute top-1/2 right-4 flex size-4 -translate-y-1/2 items-center justify-center text-base select-none md:right-2.5"
          v-html="logos[currentIconLibrary?.name]"
        />
      </PickerTrigger>
      <PickerContent
      ...
      >
        ...
        >
          <PickerGroup>
            <PickerRadioItem
              v-for="iconLibrary in Object.values(iconLibraries)"
