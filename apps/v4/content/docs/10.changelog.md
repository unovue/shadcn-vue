...
## November 2025 - New Site

We've upgraded [shadcn-vue.com](https://shadcn-vue.com/) to Nuxt v4 and Tailwind v4. The site now uses the upgraded `new-york` components.
